...
user in an INI file next to simplewallPortable.exe called
simplewallPortable.ini. If you are happy with the default options, it is not
...
simplewallPortable.ini next to simplewallPortable.exe. The options in the INI
file are as follows:
